...
var limit = 20;
var artistName;
var youtubeKey = "AIzaSyAruDAmqTVC79gNs-7-sHyVx1zyaRzYPis";
var youtubeKey2 = "AIzaSyCv3abDl7RNfGiICt80KVPOx22JWsDSBro";
                ...
                fetch(lastFmRecAPI).then(function (response) {
                    if (response.ok) {
                        response.json().then(function (data) {
                            ...
                            var youtubeAPI = "https://www.googleapis.com/youtube/v3/search?part=snippet&key=" + youtubeKey2 + "&type=video&maxResults=1&q=" + artistNameRec
...
var buildRecs = function (artistNameRec, artistBio, artistName, videoId, artistBioLong) {
    ...
    $("#intro-recs").html("if you like " + artistName + " then you may enjoy....");
